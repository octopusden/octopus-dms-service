...
class ClassicDmsServiceClient(
    private val parametersProvider: DmsServiceClientParametersProvider,
    ...
    override fun getComponentMinorVersions(componentName: String) = client.getComponentMinorVersions(componentName)
    ...
    override fun getRepositories(repositoryType: RepositoryType) = client.getRepositories(repositoryType)

    override fun getArtifact(id: Long) = client.getArtifact(id)

    override fun findArtifact(artifactCoordinates: ArtifactCoordinatesDTO) = client.findArtifact(artifactCoordinates)

    override fun downloadArtifact(id: Long) = client.downloadArtifact(id)
    ...
    private fun createClient(parametersProvider: DmsServiceClientParametersProvider): DmsServiceFeignClient {
        ...
        return Feign
            ...
            .decoder(TextBodyDecoder(JacksonDecoder(objectMapper)))
            .errorDecoder(DmsClientErrorDecoder(objectMapper))
            .requestInterceptor { requestTemplate ->
                val authHeader = getAuthHeader()
                requestTemplate.header(HttpHeaders.AUTHORIZATION, authHeader)
            }.logger(Slf4jLogger(DmsServiceFeignClient::class.java))
