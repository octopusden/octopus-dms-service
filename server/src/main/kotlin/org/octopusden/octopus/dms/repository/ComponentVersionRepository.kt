...
interface ComponentVersionRepository : JpaRepository<ComponentVersion, Long> {
    ...
    fun getMinorVersionsByComponentName(
    ...
    fun findByComponentAndVersion(
        component: Component,
        version: String,
    ): ComponentVersion?

    fun findByComponentNameAndVersion(
        componentName: String,
        version: String,
    ): ComponentVersion?
}

fun ComponentVersionRepository.getByComponentNameAndVersion(
    componentName: String,
    version: String,
