...
class ComponentVersionArtifactMapper(
    ...
    /**
     * Maps list of [ComponentVersionArtifact] to list of [ArtifactShortDTO]
     */
    fun mapToShortDTOList(artifacts: List<ComponentVersionArtifact>): List<ArtifactShortDTO> {
        return artifacts.map { mapToShortDTO(it) }
    }
